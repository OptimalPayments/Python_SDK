...
class OptimalApiClient(object):
    ...
    '''
    HostedPaymentServiceHandler
    '''
    def hosted_payment_service_handler(self):
        #Instance of class HostedPaymentService
        global hosted_payment_obj
        if hosted_payment_obj is None:
            hosted_payment_obj = HostedPaymentService(self)
            
        return (hosted_payment_obj)
